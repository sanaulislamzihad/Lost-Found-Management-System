...
- [Chapter 1: Introduction](#chapter-1-introduction)
  ...
  - [1.5 Risk Definition](#15-risk-definition)
...
- [Chapter 3: Requirements](#chapter-3-requirements)
  - [3.1 Functional Requirements](#31-functional-requirements)
    - [3.1.1 Authentication Requirements](#311-authentication-requirements)
    - [3.1.2 Lost Item Management Requirements](#312-lost-item-management-requirements)
    - [3.1.3 Found Item Management Requirements](#313-found-item-management-requirements)
    - [3.1.4 Search & Filter Requirements](#314-search--filter-requirements)
    - [3.1.5 Item Claim Requirements](#315-item-claim-requirements)
    - [3.1.6 Notification Requirements](#316-notification-requirements)
    - [3.1.7 User Profile Requirements](#317-user-profile-requirements)
    - [3.1.8 Admin Dashboard Requirements](#318-admin-dashboard-requirements)
    - [3.1.9 Database Requirements](#319-database-requirements)
...
**FR-1.1 — As a user (Student / Staff)**

I want to register an account on the system

*so that, I can securely access lost and found services under my own identity.*
...
**FR-1.2 — As a registered user**

I want to log in and log out of the system

*so that, I can access my account securely and end my session when done.*
...
*so that, other users or the finder can help me get it back.*
...
I want to edit or delete my own lost item report

*so that, I can correct mistakes or remove the post once the item is recovered.*
...
*so that, the rightful owner can be notified and reclaim their belonging.*
...
I want to edit or delete my own found item report

*so that, I can keep the listing accurate or remove it once the item is returned.*
...
I want to search lost and found items by keyword

*so that, I can quickly check if my item has already been found or reported.*
...
I want to filter items by category, location, or date

*so that, I can narrow down results and find relevant items quickly.*
...
I want to claim an item

*so that, I can retrieve my lost item from the finder or security office.*
...
**FR-5.2 — As a Security Officer**

I want to verify claims and approve or reject them

*so that, items are only released to their rightful owners.*
...
I want to receive notifications about my activity

*so that, I stay updated about my reports, claims, and matching items without checking manually.*
...
**FR-7.1 — As a registered user**

I want to view and edit my profile information

*so that, my contact details stay accurate and I control what others can see.*
...
**FR-7.2 — As a registered user**

I want to view the history of my own lost/found reports and claims

*so that, I can track the status of everything I have posted or claimed.*
...
*so that, I can keep the platform's user base accurate and safe.*
...
I want to manage item posts and categories

*so that, the platform remains organized and free of duplicate or inappropriate content.*
...
I want to view system-wide reports and statistics

*so that, I can monitor overall platform activity and performance.*
